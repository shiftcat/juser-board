...
//*** 블로그 제목 금칙단어, 블로그 설명 금칙단어 ***
//
// edited by mj.chong 2006. 09. 22
// 기획팀 김진우D 검토 후  다음과 같은 기준으로 일부를 금칙어에서 제외함
...
// 2006. 10. 09 기획팀 임삼열D 검토 후 일부 단어를 금칙어에서 제외함 (/// 표시)
function wordchk1(msg){
	arrList = new Array();
	arrList[arrList.length]	= "Royal25"; //2006. 11. 28 추가
	arrList[arrList.length]	= "royal25"; //2006. 11. 28 추가
	arrList[arrList.length]	= "racewin365"; //2006. 10. 23 추가
	arrList[arrList.length]  = "realgameok"; //2006. 10. 11 추가
	arrList[arrList.length]  = "강원랜드친구들";
	arrList[arrList.length]  = "카지노죽이기";
	arrList[arrList.length]  = "리얼게임";
	arrList[arrList.length]  = "강원랜드정보";
	arrList[arrList.length]  = "현금게임";
	arrList[arrList.length]  = "조건만남";
	// arrList[arrList.length]  = "조건 만남";
    ...
    //arrList[arrList.length]="망가"; //2006.9.20 고객 문의로 금칙어에서 제외
    ...
    //arrList[arrList.length]="구멍"; //2006.9.20 고객 문의로 금칙어에서 제외
    ...
    //arrList[arrList.length]="hidden"; //2006. 10. 9 제외
	...
	arrList[arrList.length]="7poka.com";
	arrList[arrList.length]="hanapoker.com";
	arrList[arrList.length]="naragame.com";
	arrList[arrList.length]="pokerclub777.com";
	arrList[arrList.length]="power.clubpoker24.com";
	arrList[arrList.length]="vipgameclub.com";
	arrList[arrList.length]="www.018race.com";
	arrList[arrList.length]="www.2005race.com";
	arrList[arrList.length]="www.3goclub.com";
	arrList[arrList.length]="www.505race.com";
	arrList[arrList.length]="www.666race.com";
	arrList[arrList.length]="www.900race.com";
	arrList[arrList.length]="www.ace777.com";
	arrList[arrList.length]="www.cherrygame.com";
	arrList[arrList.length]="www.clubpoker24.com";
	arrList[arrList.length]="www.cyworld.com/sexy6986";
	arrList[arrList.length]="www.ebetgame.com";
	arrList[arrList.length]="www.fwatufae.com";
	arrList[arrList.length]="www.gameqqq.com";
	arrList[arrList.length]="www.goxgame.net";
	arrList[arrList.length]="www.hangamegostop.com";
	arrList[arrList.length]="www.icashgame.com";
	arrList[arrList.length]="www.lulupoker.com";
	arrList[arrList.length]="www.nolbugame.com";
	arrList[arrList.length]="www.poker7700.com";
	arrList[arrList.length]="www.realgameland.com";
	arrList[arrList.length]="www.realgamezone.com";
	arrList[arrList.length]="www.tazza24.com";
	arrList[arrList.length]="www.tazza365.net";
	arrList[arrList.length]="www.touchking.co.kr";
	arrList[arrList.length]="www.zzanggame.com";
	arrList[arrList.length]="www. casinohan.com";
	arrList[arrList.length]="www.018race.com";
	arrList[arrList.length]="www.3gomax.com";
	arrList[arrList.length]="www.52cam.co.kr";
	arrList[arrList.length]="www.700race.com";
	arrList[arrList.length]="www.7goclub.com";
	arrList[arrList.length]="www.7goclub.com";
	arrList[arrList.length]="www.900race.com";
	arrList[arrList.length]="www.acepoker999.com";
	arrList[arrList.length]="www.asuspoker.com";
	arrList[arrList.length]="www.comoney.com";
	arrList[arrList.length]="www.fullhouse24.com";
	arrList[arrList.length]="www.gameclub777.com";
	arrList[arrList.length]="www.GoldPoker777.com";
	arrList[arrList.length]="www.gostop.com";
	arrList[arrList.length]="www.Gostop3000.com";
	arrList[arrList.length]="www.gostopmoney.com";
	arrList[arrList.length]="WWW.hanapoker.com";
	arrList[arrList.length]="www.hangamegostop.com";
	arrList[arrList.length]="www.hangamepoker.com";
	arrList[arrList.length]="www.icashgame.com";
	arrList[arrList.length]="www.kb0666.com";
	arrList[arrList.length]="www.lacasino24.com";
	arrList[arrList.length]="www.lullulala.com";
	arrList[arrList.length]="www.poker7700.com";
	arrList[arrList.length]="www.pokerclub777.com";
	arrList[arrList.length]="www.PokerGame365.com";
	arrList[arrList.length]="www.pokerhouse888.com";
	arrList[arrList.length]="www.PokerHouse888.com";
	arrList[arrList.length]="www.RealGameZone.com";
	arrList[arrList.length]="www.royalpoker24.com";
	arrList[arrList.length]="www.sangflash.com";
	arrList[arrList.length]="www.viproom365.com";
    // arrList[arrList.length]  = "자살";
	// arrList[arrList.length]  = "음독";
	arrList[arrList.length]  = "청산가리";
	arrList[arrList.length]  = "청산가루";
	arrList[arrList.length]  = "018race";
	arrList[arrList.length]  = "2005race";
	arrList[arrList.length]  = "3goclub";
	arrList[arrList.length]  = "3gomax";
	arrList[arrList.length]  = "505race";
	arrList[arrList.length]  = "52cam";
	arrList[arrList.length]  = "666race";
	arrList[arrList.length]  = "700race";
	arrList[arrList.length]  = "7goclub";
	arrList[arrList.length]  = "7poka";
	arrList[arrList.length]  = "900race";
	arrList[arrList.length]  = "ace777";
	arrList[arrList.length]  = "acepoker";
	arrList[arrList.length]  = "asuspoker";
	arrList[arrList.length]  = "casinohan";
	arrList[arrList.length]  = "cherrygame";
	arrList[arrList.length]  = "clubpoker";
	arrList[arrList.length]  = "comoney";
	arrList[arrList.length]  = "cyworld.com/sexy6986";
	arrList[arrList.length]  = "donmany";
	arrList[arrList.length]  = "ebetgame";
	arrList[arrList.length]  = "fullhouse24";
	arrList[arrList.length]  = "fwatufae";
	arrList[arrList.length]  = "gameclub777";
	arrList[arrList.length]  = "gameqqq";
	arrList[arrList.length]  = "GoldPoker";
	arrList[arrList.length]  = "gostop.com";
	arrList[arrList.length]  = "Gostop3000";
	arrList[arrList.length]  = "gostopmoney";
	arrList[arrList.length]  = "goxgame";
	arrList[arrList.length]  = "hanapoker";
	arrList[arrList.length]  = "hangamegostop";
	arrList[arrList.length]  = "hangamepoker";
	arrList[arrList.length]  = "icashgame";
	arrList[arrList.length]  = "kb0666";
	arrList[arrList.length]  = "lacasino";
	arrList[arrList.length]  = "lullulala.com";
	arrList[arrList.length]  = "lulupoker";
	arrList[arrList.length]  = "naragame";
	arrList[arrList.length]  = "nolbugame";
	arrList[arrList.length]  = "poker7700";
	arrList[arrList.length]  = "pokerclub";
	arrList[arrList.length]  = "PokerGame";
	arrList[arrList.length]  = "pokerhouse";
	arrList[arrList.length]  = "pridejacks";
	arrList[arrList.length]  = "racepoker";
	arrList[arrList.length]  = "realgameland";
	arrList[arrList.length]  = "RealGameZone";
	arrList[arrList.length]  = "realpoker";
	arrList[arrList.length]  = "royalpoker";
	arrList[arrList.length]  = "sangflash";
	arrList[arrList.length]  = "tazza24";
	arrList[arrList.length]  = "tazza365";
	arrList[arrList.length]  = "touchking";
	arrList[arrList.length]  = "vipgameclub";
	arrList[arrList.length]  = "viproom365";
	arrList[arrList.length]  = "zzanggame";
...
function wordchk2(msg){
	...
	// arrList[arrList.length]  = "가게주인"; //2006.9.20 고객 문의로 금칙어에서 제외
	...
	//arrList[arrList.length]  = "선물가게"; //2006.10.23 사용자 요청으로 제외
	...
	//arrList[arrList.length]  = "페이퍼"; //2006. 10. 9 제외
	...
	//arrList[arrList.length]  = "섹"; //2006. 10. 9 고객요청으로 제외
	...
	arrList[arrList.length]  = "야동";
	//arrList[arrList.length]  = "야사"; //2006.11.02 고객문의로 제외처리
	arrList[arrList.length]  = "야설";
